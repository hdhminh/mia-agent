...
WORKFLOWS = [
    ...
    INTEGRATIONS / "google/calendar/workflow_sub_google_calendar_master.json",
    INTEGRATIONS / "google/gmail/workflow_sub_google_gmail_master.json",
    INTEGRATIONS / "google/drive/workflow_sub_google_drive_master.json",
    INTEGRATIONS / "google/docs/workflow_sub_google_docs_master.json",
    INTEGRATIONS / "google/sheets/workflow_sub_google_sheets_master.json",
...
const publicBaseUrl = String($env.SHORTLINK_PUBLIC_BASE_URL || 'https://go.example.com').replace(/\\/+$/, '');
