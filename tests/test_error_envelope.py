...
# Force Vietnamese locale for tests that assert Vietnamese output strings
...
from agent.execution_client import N8nToolGatewayClient, ToolGatewayResult
...
class ErrorEnvelopeTests(unittest.TestCase):
    ...
    def test_direct_executor_time_now_uses_context_timezone(self) -> None:
        ...
        with patch(
            "agent.brain.direct_executor.build_current_date_response",
            return_value={
