...
from mia_core.approval import ApprovalRepository
...
from mia_core.models import MiaChatRequest, MiaChatResponse, MiaFeedbackRequest, MiaFeedbackResponse
from mia_core.n8n_client import N8nToolGatewayClient
from mia_core.media.routes import router as media_router
from mia_core.media.service import MediaService
from mia_core.web.routes import router as web_router
from mia_core.web.service import WebService
...
def mia_feedback(request: MiaFeedbackRequest) -> MiaFeedbackResponse:
    ...
    try:
        ...
        envelope = build_exception_envelope(
            ...
            category="internal",
            severity="error",
            user_message="Mia chưa ghi nhận được feedback này. Bạn thử lại sau nhé.",
            retryable=False,
            source=ErrorSource(
                layer="api",
                component="app",
