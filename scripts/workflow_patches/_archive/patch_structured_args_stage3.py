...
def patch_calendar_delete_prepare(code: str) -> str:
    ...
    code = replace_or_fail(
        ...
        "const calendarId = source.calendarId || args.calendarId || payload.calendarId || 'kuminhuynhdoan@gmail.com';",
